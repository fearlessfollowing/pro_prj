...
/*
 * 类weakref_impl继承自RefBase::weakref_type, 所以得到了该类的一些操作方法
 */
...
public:
    ...
    weakref_impl(RefBase* base): mStrong(INITIAL_STRONG_VALUE)
    									, mWeak(0)
    									, mBase(base)
    									, mFlags(0)
    {
...
/***********************************************************************************
** 函数名称: RefBase
** 函数功能: RefBase引用计数类的构造函数
** 入口参数: 无
** 返 回 值: 无
** 原理: 在RefBase的构造函数中会创建weakref_impl对象,并让RefBase.mRefs = new weak_impl(this);
*************************************************************************************/
