...
/*********************************************************************************************
** 方法名称: SocketClient::SocketClient
** 方法功能: 构造函数
** 入口参数: 
**			socket - 与客户端通信的文件描述符
**			owned - 
...
/*********************************************************************************************
** 方法名称: SocketClient::incRef
** 方法功能: 增加SocketClient对象的引用计数
** 入口参数: 无
** 返 回 值: 无
**
**
...
/*********************************************************************************************
** 方法名称: SocketClient::decRef
** 方法功能: 减少SocketClient对象的引用计数
** 入口参数: 无
** 返 回 值: 需要释放SocketClient对象返回true;否则返回false
**
**
**********************************************************************************************/
